...
function devPHP(){
  return src(`${options.paths.base}/**/*.php`).pipe(dest(options.paths.dist.base));
} 
...
function watchFiles(){
  watch(`${options.paths.base}/**/*.php`,series(devPHP, devStyles, previewReload));
...
exports.default = series(
  ...
  parallel(devStyles, devScripts, devImages, devFonts, devHTML, devPHP), //Run All tasks in parallel
